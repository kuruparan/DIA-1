...
<div class="container">
    <div class="row">
        <div class="col-sm-2 col-sm-offset-10">
            <form action="createEndPoint" method="get">
                <input type="hidden" name="deviceName" value="<c:out value="${device.deviceName}"/>"/>
                <button style="margin:5%" type="submit" class="btn btn-lg btn-success col-sm-12">Create End Point
                </button>
            </form>
        </div>
    </div>
    ...
    <div class="jumbotron">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">End Points</div>
            <!-- Table -->
            <table class="table" data-link="row">
                ...
                <c:forEach items="${endPoints}" var="endPoint">
                    <tr>
                        <th><a href="${contextPath}/endPoint?id=<c:out value='${endPoint.id}'/>"><c:out
                                value="${endPoint.id}"/></a></th>
                        <th><c:out value="${endPoint.currentStatus}"/></th>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
